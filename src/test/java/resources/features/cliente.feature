...
Funcionalidade: Gestão de Clientes
  ...
  # Cenário para Cadastrar Novo Cliente
  Cenário: Cadastrar um novo cliente
    Dado que o usuário deseja cadastrar um novo cliente
    Quando ele envia os dados do cliente com nome "João Silva", CPF "12345678901", e e-mail "joao@gmail.com"
    Então o sistema deve criar o cliente e retornar status 200

  # Cenário para Listar Todos os Clientes
  ...
  # Cenário para Atualizar Informações de um Cliente
  ...
  # Cenário para Deletar um Cliente
